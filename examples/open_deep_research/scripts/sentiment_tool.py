...
class SentimentTool(Tool):
    ...
    description = (
        ...
        stock tickers (e.g., 'AAPL,005930.KS'), calculates technical indicators 
        ...
        real-time price data for the requested tickers, and visualizes the price data and volume in graphs."""
    )
    inputs = {
        "tickers": {
            "type": "string",
    ...
    def forward(self, tickers: str) -> str:
        ...
        for ticker in ticker_list:
            ...
            # 기술적 지표 계산 - SMA만 계산 (RSI와 볼린저 밴드 제외)
            ...
            # 그래프 시각화 생성 (2개의 subplot: 상단은 가격 및 이동평균, 하단은 거래량)
            ...
            # 거래량 선그래프로 시각화
            ax2.plot(df["Date"], df["Volume"], label="Volume", color="green")
